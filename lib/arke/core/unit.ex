...
defmodule Arke.Core.Unit do
  ...
  defp get_link(%{depth: depth, link_metadata: link_metadata, link_before_node: link_before_node} = args),
    do: {%{depth: depth, metadata: link_metadata, link_before_node: link_before_node}, args}
